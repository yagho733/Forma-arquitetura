...
if(refugioImg){
  refugioImg.src='https://unsplash.com/photos/GvOcpTNAHFo/download?force=true&w=2200';
  protectImage(refugioImg);
}
const lumeImg=cards[4]?.querySelector('img');
if(lumeImg){
  lumeImg.src='https://unsplash.com/photos/mCQ-ykj6tQk/download?force=true&w=2200';
